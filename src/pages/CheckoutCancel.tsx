      ...
      <div className="container mx-auto px-4 py-16 max-w-2xl">
        <div className="text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            Your payment was cancelled and no charges were made to your account. You can try again or explore other options.
          </p>
          ...
          <Card className="mb-8">
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground">
                You cancelled the payment process before it was completed. Your subscription 
                was not activated and no charges were applied to your payment method.
              </p>
              <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                <p className="text-sm text-blue-800">
                  <strong>Good news:</strong> You can return to the pricing page anytime to 
                  subscribe and start creating beautiful family stories.
                </p>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <div className="space-y-4 text-left">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Explore the free features available while you decide on a subscription.
                  </p>
                </div>
              </div>
            </CardContent>
          ...
          <div className="mt-12 p-6 bg-muted/30 rounded-lg">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              ...
              We can assist with payment problems or answer any questions about our plans.
            </p>
