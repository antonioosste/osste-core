...
const plans = [
  ...
  },
  {
    ...
    price: 39,
    priceLabel: "$39",
    description: "Your memories preserved",
    icon: Star,
    features: [
      ...
      "Unlimited rewrites",
      "Permanent storage",
      "Continue adding stories anytime",
      "Photo uploads",
    ],
    notIncluded: [
      "Printed book",
  ...
  },
  {
    ...
    price: 129,
    priceLabel: "$129",
    description: "Turn your story into a physical book",
    icon: Crown,
    features: [
...
const faqs = [
  ...
  },
  {
    ...
    answer: "Free projects are archived after 30 days — your data is preserved but editing is locked. Upgrade anytime to restore full access and unlock permanent storage.",
  },
  {
  ...
  },
  {
    ...
    answer: "The Legacy plan includes one professionally printed hardcover book shipped to your address, with professional formatting and a custom cover design. You can reorder additional copies anytime.",
  },
  {
    question: "How much recording time do I get?",
    answer: "Free includes 20 minutes, Digital includes 60 minutes, and Legacy includes 120 minutes. Recording time is shared across all your books at the account level.",
  },
  {
